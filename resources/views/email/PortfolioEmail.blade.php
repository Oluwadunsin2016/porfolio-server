{{-- @component('mail::message')
    <p>Below is your portfolio url. You can share it with your friends</p>
    <a href={{'http://localhost:5175/'.$user['info_token']}}>{{'http://localhost:5175/'.$user['info_token']}}</a>
...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <p>Thanks for creating your portfolio here.</p>
      <p>Below is your portfolio url. You can share it with your employers</p>
      <div class="button_container">
        <a href={{'vue-portfolio-alpha-three.vercel.app/'.$user['info_token']}} >{{'vue-portfolio-alpha-three.vercel.app/'.$user['info_token']}}</a>
      </div>
      <p>If you did not create an account, no further action is required</p>
